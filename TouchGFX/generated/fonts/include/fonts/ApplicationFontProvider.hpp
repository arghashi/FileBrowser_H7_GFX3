...
struct Typography
{
    ...
    static const touchgfx::FontId TYPO_15 = 6;
};
...
struct TypographyFontIndex
{
    ...
    static const touchgfx::FontId MODE = 2;     // segoeui_20_4bpp
    static const touchgfx::FontId DEFAULT = 2;  // segoeui_20_4bpp
    static const touchgfx::FontId DISPLAY = 2;  // segoeui_20_4bpp
    static const touchgfx::FontId KEYBOARD = 2; // segoeui_20_4bpp
    static const touchgfx::FontId TYPO_15 = 3;  // segoeui_15_4bpp
